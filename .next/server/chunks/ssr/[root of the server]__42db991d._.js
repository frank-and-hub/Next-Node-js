...
(()=>{
    const e = new Error("Cannot find module '../components/admin/comman/notification/Notification'");
...
const request = async (method, url, data = {})=>{
    try {
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$utils$2f$helper$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"])();
        const config = {
            method,
            url: baseUrl + url,
            headers: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__42db991d._.js.map